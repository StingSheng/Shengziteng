...
// email判定
function emailJudge(inputEmail) {
...
// 判断内容是否符合要求
function contentJudge(inputContent) {
...
submit.addEventListener('click', event => {
    ...
    let inputContent = document.querySelector('.content-input').value;
    let inputHint = document.querySelector('.hint-input').value;
    // 进行四种判定
    nameJudge(inputName);
